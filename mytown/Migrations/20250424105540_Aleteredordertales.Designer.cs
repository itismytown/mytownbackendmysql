...
namespace mytown.Migrations
{
    ...
    [Migration("20250424105540_Aleteredordertales")]
    partial class Aleteredordertales
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mytown.Models.ShippingDetails", b =>
                {
                    b.HasOne("mytown.Models.orderdetails", "OrderDetail")
                        .WithMany()
                        .HasForeignKey("OrderDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mytown.Models.Order", null)
